...
class _FakeLogger_7 extends _i1.SmartFake implements _i4.Logger {
  _FakeLogger_7(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockPostRemoteDataSource extends _i1.Mock
  ...
  @override
  _i6.Future<List<_i2.PostModel>> fetchAll() => (super.noSuchMethod(
        Invocation.method(
          #fetchAll,
          [],
        ),
        returnValue: _i6.Future<List<_i2.PostModel>>.value(<_i2.PostModel>[]),
      ) as _i6.Future<List<_i2.PostModel>>);

  @override
  _i6.Future<_i2.PostModel> fetchPostById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #fetchPostById,
          [id],
        ),
        returnValue: _i6.Future<_i2.PostModel>.value(_FakePostModel_0(
          this,
          Invocation.method(
            #fetchPostById,
            [id],
...
class MockGetConnect extends _i1.Mock implements _i3.GetConnect {
  ...
  _i6.Future<_i3.Response<T>> get<T>(
    ...
    _i3.Decoder<T>? decoder,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i6.Future<_i3.Response<T>>.value(_FakeResponse_4<T>(
          this,
          Invocation.method(
            #get,
            [url],
  ...
  @override
  _i6.Future<_i3.GraphQLResponse<T>> query<T>(
    String? query, {
    String? url,
    ...
    Map<String, String>? headers,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i6.Future<_i3.GraphQLResponse<T>>.value(_FakeGraphQLResponse_6<T>(
          this,
          Invocation.method(
            #query,
            [query],
      ...
      ) as _i6.Future<_i3.GraphQLResponse<T>>);

  @override
  _i6.Future<_i3.GraphQLResponse<T>> mutation<T>(
    String? mutation, {
    String? url,
    Map<String, dynamic>? variables,
    Map<String, String>? headers,
...
class MockPostRemoteDataSourceImpl extends _i1.Mock
  ...
  _i6.Future<List<_i2.PostModel>> fetchAll() => (super.noSuchMethod(
        ...
        returnValueForMissingStub:
            _i6.Future<List<_i2.PostModel>>.value(<_i2.PostModel>[]),
      ) as _i6.Future<List<_i2.PostModel>>);

  @override
  _i6.Future<_i2.PostModel> fetchPostById(int? postId) => (super.noSuchMethod(
        Invocation.method(
          #fetchPostById,
          [postId],
        ),
        ...
        returnValueForMissingStub:
            _i6.Future<_i2.PostModel>.value(_FakePostModel_0(
          this,
          Invocation.method(
            #fetchPostById,
            [postId],
  ...
  _i6.Future<_i3.Response<T>> get<T>(
    ...
    _i3.Decoder<T>? decoder,
      ...
      (super.noSuchMethod(
        ...
        returnValueForMissingStub:
            _i6.Future<_i3.Response<T>>.value(_FakeResponse_4<T>(
          this,
          Invocation.method(
            #get,
            [url],
